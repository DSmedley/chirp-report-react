            ...
            tooltip: {
                callbacks: {
                    label: function(context: TooltipItem<"bar">) {
                        let tweetCount = context.dataset.data[context.dataIndex]
                        let totalTweets = context.dataset.data.reduce(function(a, b){return a + b;}, 0)
                        let percentage = Math.round(tweetCount/totalTweets*100)
